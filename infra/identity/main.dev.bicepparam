...
param sqlDatabaseUseFreeLimit = bool(readEnvironmentVariable('SQL_DATABASE_USE_FREE_LIMIT'))
param sqlDatabaseFreeLimitExhaustionBehavior = readEnvironmentVariable('SQL_DATABASE_FREE_LIMIT_EXHAUSTION_BEHAVIOR', 'AutoPause')
param sqlDatabaseBackupStorageRedundancy = readEnvironmentVariable('SQL_DATABASE_BACKUP_STORAGE_REDUNDANCY', 'Local')
